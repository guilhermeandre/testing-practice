...
try {
  ...
  var result = product(4,4,4,4,4);
  if (result !== 16) throw new Error('Expected product(4,4,4,4,4) to be 16. Received: ' +result);
  ...
  if (result !== 0) throw new Error('Expected product(4) to be 0. Every number multiplied by 0 must be 0. Received: ' +result);
  // --------------------------------------------------
  // Test Case 5
  // --------------------------------------------------
  // When invoked with no numbers, it should return 0.
  var result = product();
  if (result !== 0) throw new Error('Exepected product() to be 0. Received: ' +result)
