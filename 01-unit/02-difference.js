...
try {
  ...
  if (result !== 0) throw new Error('Exepected diference(1,1,1,1,1,1,1) to be 0. Received: ' + result);
  ...
  if (result !== 0) throw new Error('Exepected difference () to be 0. Received: ' + result);
